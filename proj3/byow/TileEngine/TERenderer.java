...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world) {
        ...
        StdDraw.setPenColor(new Color(20, 80, 120));
        StdDraw.filledRectangle(50, 51, 50, 2);
        Font font = new Font("Monaco", Font.BOLD, 40);
        StdDraw.setPenColor(Color.WHITE);
        StdDraw.text(15, 51, "Examination Descriptor: " + updateUI(world));
        StdDraw.text(40, 51, ":Q to quit and save    :R to restart    WASD to move");
        StdDraw.show();
    }

    public String updateUI(TETile[][] world) {
        int xTile = (int) (StdDraw.mouseX());
        int yTile = (int) (StdDraw.mouseY());
        if (xTile < world.length && yTile < world[0].length) {
            TETile hoverTile = world[xTile][yTile];
            return hoverTile.description();
        }
        return "Mouse Offscreen";
    }
}
